...
<div class="sign_up">
    ...
    <div class="form_size">Choose what you would like to be notified on</div>

      <input type="checkbox" id="product" name="product1" value="#">
      <label class="#" for="product1">Flights Offer</label><br>
      <input type="checkbox" id="product" name="product2" value="#">
      <label class="#" for="product2">Packages</label><br>
      <input type="checkbox" id="product" name="product3" value="#">
      <label class="#" for="product3">Visa Offers</label><br>
      <input type="checkbox" id="product" name="product3" value="#">
      <label class="#" for="product3">Accomidation Offers</label><br>
